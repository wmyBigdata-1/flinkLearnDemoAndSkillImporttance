 ...
 * @Descirption: 最后是整个逻辑功能的主体：ProcessTime.java，这里面有自定义的KeyedProcessFunction子类，还有程序入口的main方法
 * 体验KeyedProcessFunction类(时间类型是处理时间)
 *
 */
public class ProcessTime {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 监听本地9999端口，读取字符串
        DataStream<String> socketDataStream = env.socketTextStream("yaxin01", 9999);
